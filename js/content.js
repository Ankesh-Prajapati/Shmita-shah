...
const SITE = {
  ...
  eye: { chapter: "Chapter 01 — The Eye", title: "She sees it before it happens.",
    p1: "Shmitaa is a cinematographer, photographer and visual storyteller. Her work begins with patience: waiting for the breath before the laugh, the glance before the embrace.",
  ...
  chareveti: { chapter: "Chapter 02 — Chareveti Films", wm1: "चरैवेति", wm2: "FILMS", tag: "Keep moving. Keep going.", role: "Founder & Cinematographer",
    p1: "Shmitaa first founded Chareveti Films. The name, चरैवेति, is a philosophy she follows in her own life — keep moving, keep going, never stop. It reflects how she approaches life, creativity and overcoming challenges." },
  ...
  joy: { chapter: "Chapter 03 — Joykeneth", name: "Joykeneth", line: "Someone who became family by the heart.",
    p1: "Later, Joykeneth became an important part of Shmitaa's life — someone she loves and considers like her own son. The bond, and the happiness that came with it, inspired what came next." },
  moj: { chapter: "Chapter 04 — Memories of Joy", wm1: "Memories of Joy", wm2: "", tag: "A name inspired by the joy and memories connected to him.", role: "Wedding & pre-wedding photography",
    p1: "Shmitaa changed the company's name from Chareveti Films to Memories of Joy. Chareveti is her philosophy of moving forward; Memories of Joy is a deeply personal chapter of her life.",
  ...
  images: {
    hero:      { src: "assets/photo-girl-bw.jpg",     alt: "Black and white portrait of Shmitaa, eyes closed",   caption: "Stillness",  pos: "50% 40%" },
    eye:       { src: "assets/photo-portrait.jpg",    alt: "Portrait of Shmitaa smiling, seated on stone steps",  caption: "Portrait",   pos: "50% 30%" },
