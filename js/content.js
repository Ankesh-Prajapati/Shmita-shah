...
const SITE = {
  ...
  chareveti: { chapter: "Chapter 02 — Chareveti Films", wm1: "चरैवेति", wm2: "FILMS", role: "Founder & Cinematographer",
    p1: "Where the journey began. Chareveti — to keep moving forward — became a way of looking: unhurried, honest and always in motion." },
  moj: { chapter: "Chapter 03 — Memories of Joy", wm1: "Memories of Joy", wm2: "", title: "Love stories, kept.", role: "Wedding & pre-wedding photography",
    p1: "Weddings and pre-wedding stories from Surat and Mumbai, told through light, movement and the small moments in between — the ones that outlast the day." },
  tss: { chapter: "Chapter 04 — Tinyy Steps Studio", wm1: "Tinyy Steps", wm2: "STUDIO", title: "The earliest chapters.", role: "Founder",
  ...
  framesIntro: { chapter: "Chapter 05 — The Frames", title: "Stills from the archive." },
  beyond: { chapter: "Chapter 06 — Beyond the Frame", title: "The person behind the camera.",
    bio: "Founder of Chareveti Films and Tinyy Steps Studio, telling wedding and pre-wedding stories as Memories of Joy. Shmita is a cinematographer, photographer and visual storyteller based in Surat, Gujarat. She believes in emotion, movement and moments that cannot be recreated. Light is only the language. The story is always the person in front of the lens.",
  ...
  work: [["Chareveti Films","Founder & Cinematographer"],["Memories of Joy","Wedding & pre-wedding"],["Tinyy Steps Studio","Founder · trusted by 1000+ mothers"],["",""]],
  places: [["Surat","Gujarat"],["Mumbai","Maharashtra"],["[Add location]",""]],
  final: ["Some moments happen once.", "Some stories deserve to live forever."],
  links: {
    chareveti: { label: "@chfilms_surat on Instagram",     href: "https://www.instagram.com/chfilms_surat/" },
    moj:       { label: "@memories_of_joy__ on Instagram", href: "https://www.instagram.com/memories_of_joy__/" },
    tss:       { label: "@tinyysteps_studio on Instagram", href: "https://www.instagram.com/tinyysteps_studio/" }
  },
  contact: [
    { label: "@chfilms_surat",     href: "https://www.instagram.com/chfilms_surat/" },
    { label: "@memories_of_joy__", href: "https://www.instagram.com/memories_of_joy__/" },
    { label: "@tinyysteps_studio", href: "https://www.instagram.com/tinyysteps_studio/" }
    /* , { label: "hello@yourdomain.com", href: "mailto:hello@yourdomain.com" } */
  ],
  footer: "© Shmita Shah",
